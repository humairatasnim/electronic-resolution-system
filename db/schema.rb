...
ActiveRecord::Schema.define(:version => 20140127081740) do
  ...
  create_table "committees_conferences", :force => true do |t|
    t.integer "committee_id"
    t.integer "conference_id"
  end

  add_index "committees_conferences", ["committee_id"], :name => "index_committees_conferences_on_committee_id"
  add_index "committees_conferences", ["conference_id"], :name => "index_committees_conferences_on_conference_id"
